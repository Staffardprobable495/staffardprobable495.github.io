...
<p align="center" style="background: white; padding: 25px 10px; border-radius: 8px; margin-bottom: 20px;">
  ...
  <img src="LMS.png" height="65" style="vertical-align: middle;">
</p>
...
<!--<p align="center" style="margin: 30px 0;">
  <a href="AQUÍ_VA_EL_ENLACE_DE_COMPARTIR_DE_TU_MICROSOFT_FORMS" target="_blank" style="background: linear-gradient(135deg, #203a43, #2c5364); color: white; padding: 16px 40px; border-radius: 6px; font-size: 16px; font-weight: bold; text-decoration: none; box-shadow: 0 4px 15px rgba(0,0,0,0.15); display: inline-block; transition: transform 0.2s;">
